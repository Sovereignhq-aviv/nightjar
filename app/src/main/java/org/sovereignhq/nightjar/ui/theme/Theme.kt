package org.sovereignhq.nightjar.ui.theme
...
val NightjarColors = darkColorScheme(
    primary = Indigo,
    onPrimary = IndigoInk,
...
fun NightjarTheme(content: @Composable () -> Unit) {
    MaterialTheme(colorScheme = NightjarColors, typography = typography, content = content)
}
