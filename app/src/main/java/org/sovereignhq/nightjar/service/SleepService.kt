...
import org.sovereignhq.nightjar.alarm.AlarmPlayer
import org.sovereignhq.nightjar.audio.EventDetector
import org.sovereignhq.nightjar.audio.NightRecorder
import org.sovereignhq.nightjar.audio.YamnetClassifier
...
import org.sovereignhq.nightjar.sensor.MotionMonitor
import org.sovereignhq.nightjar.sleep.ActivityAggregator
import org.sovereignhq.nightjar.sleep.BreathEstimator
import org.sovereignhq.nightjar.sleep.SleepClassifier
import org.sovereignhq.nightjar.sleep.SmartAlarm
...
class SleepService : Service(), NightRecorder.Listener, EventDetector.Listener {
    ...
    private fun acquireWakeLock() {
        ...
        wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "nightjar:night").apply {
    ...
    companion object {
        ...
        const val ACTION_START = "org.sovereignhq.nightjar.START"
        const val ACTION_STOP = "org.sovereignhq.nightjar.STOP"
        const val ACTION_FIRE_ALARM = "org.sovereignhq.nightjar.FIRE_ALARM"
        const val ACTION_SNOOZE = "org.sovereignhq.nightjar.SNOOZE"
        const val ACTION_DISMISS = "org.sovereignhq.nightjar.DISMISS"
        const val ACTION_QUIET = "org.sovereignhq.nightjar.QUIET"
